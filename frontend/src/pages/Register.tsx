        ...
        <div className="card">
          ...
          >
            ...
            <p style={{ margin: "5px 0", fontSize: "0.85rem", color: "#666" }}>
              Please use the official role-based email domain provided by your
              department or for personal use.
            </p>
            <p
              style={{
                margin: "5px 0",
            ...
            >
              ⚠️ All fields are mandatory. Profile details can be edited later
              from dashboard.
            </p>
          </div>
